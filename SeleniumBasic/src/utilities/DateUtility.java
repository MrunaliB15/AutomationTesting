...
public class DateUtility {
	...
	public static void main(String[] args) {
		...
		System.out.println(getRequiredDateBasedOnNumberOfDays("dd MMMM yyyy", -5));
	}
		...
		public static void compairDate(String Date1, String Date2) {
		}
		public static String getRequiredDateBasedOnNumberOfDays1(String format, int numberOfDays) {
			Calendar cal= Calendar.getInstance();
			cal.add(Calendar.DATE,numberOfDays);
			cal.add(Calendar.DATE,numberOfDays);
			SimpleDateFormat s =new SimpleDateFormat(format);
