...
public class MouseOps4 {
	...
	public static void main(String[] args) {
         ...
         //setting a path for driver executable
         System.setProperty("webdriver.chrome.driver",chromeExepath);
         //create an instance of chrome driver and up casting it to web driver
         //interface
         ...
         //userNameInputField.sendKeys(Keys.chord(Keys.CONTRL,"a"));
                    //OR
